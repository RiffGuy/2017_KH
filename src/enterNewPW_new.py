...
"border-width: 10px;")
        ...
        self.new_2 = QtWidgets.QLabel(self.gridWidget)
        self.new_2.setStyleSheet("border-style: solid;\n"
                                 "border-color: rgb(255, 255, 255);\n"
                                 "border-width: 10px;")
        self.new_2.setObjectName("new_2")
        self.gridLayout.addWidget(self.new_2, 6, 1, 1, 2)
        MainWindow.setCentralWidget(self.centralwidget)
...
"</html>"))
        ...
        self.new_2.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:26pt; font-weight:600; color:#ffffff;\">새로운 비밀번호를</span></p><p align=\"center\"><span style=\" font-size:26pt; font-weight:600; color:#ffffff;\">입력해주세요</span></p></body></html>"))
