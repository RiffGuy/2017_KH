...
"border-width: 10px;")
        ...
        self.insert = QtWidgets.QLabel(self.gridWidget)
        self.insert.setStyleSheet("border-style: solid;\n"
                                  "border-color: rgb(255, 255, 255);\n"
                                  "border-width: 10px;")
        self.insert.setObjectName("insert")
        self.gridLayout.addWidget(self.insert, 6, 1, 1, 2)
        MainWindow.setCentralWidget(self.centralwidget)
...
"</html>"))
        ...
        self.insert.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:26pt; font-weight:600; color:#ffffff;\">비밀번호를</span></p><p align=\"center\"><span style=\" font-size:26pt; font-weight:600; color:#ffffff;\">입력해주세요</span></p></body></html>"))
